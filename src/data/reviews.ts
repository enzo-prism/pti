...
const documentReviews: ReviewRecord[] = [
  ...
  {
    id: "internal-madison-brown-dds-ive-had-the-privilege",
    slug: "madison-brown-dds-ive-had-the-privilege",
    source: "internal",
    category: "buyer",
    rating: 5,
    quote:
      "I've had the privilege of knowing Michael for the past five years. We first met in dental school when he was mentoring our business club, and since then he's been there through every major milestone. He helped me land my first associate position, where I learned so much about the business side of dentistry, and more recently he helped guide me through becoming a practice owner. Throughout it all, he's been a trusted mentor, advisor, and friend. What I appreciate most about Michael is his honesty and integrity. He's straightforward, tells you what you need to hear, and always backs his advice with actionable recommendations. His experience, insight, and ability to identify opportunities for growth and efficiency have been incredibly valuable. I'm grateful for the impact he's had on both my professional journey and personal growth. I highly recommend him to any dentist looking for a practice acquisition or consultant for their office!",
    sourceAuthorName: "Madison Brown, DDS",
    displayAuthorName: "Madison Brown, DDS",
    role: "Practice Owner",
    sourceDateISO: "2026-06-16",
    sortOrder: 84,
  },
  {
    id: "internal-chris-p-i-was-recommended-to",
    slug: "chris-p-i-was-recommended-to",
    source: "internal",
    category: "workshop",
    rating: 5,
    quote:
      "I was recommended to attend one of Dr. Michael Njo's transition courses through his educational company, Practice Transitions Institute. Although I am still more than five years away from selling my practice, I felt it would be wise to begin learning about what the future may hold. A close colleague of mine, who had successfully sold his practice, strongly encouraged me to attend the course. Wow — I learned an incredible amount. Dr. Njo packed a tremendous amount of valuable information into the program. The time flew by because he has a unique ability to make what could otherwise be very dry and technical material engaging, interesting, and highly practical. During the course, I also learned that Dr. Njo owns a practice management company called Dental Strategies. I had never heard of it before, likely because his business is built almost entirely through direct referrals and reputation. After attending the course, I decided I wanted to hire Dr. Njo as my practice management consultant, primarily to help prepare my practice for the next generation and position it for long-term success. Ironically, the very Monday after returning to my office, I received a letter from Delta Dental informing me that my office had been selected for an audit. At that moment, I truly felt like my world was crashing down. The audit request contained a long list of items they wanted reviewed and prepared. As I began researching and evaluating my systems, I quickly realized there were several areas that needed correction and that there were things I had unknowingly been doing incorrectly. As the saying goes, \"You don't know what you don't know.\" When I spoke with Dr. Njo during our scheduled call that Monday, I shared the audit letter and my concerns about the areas Delta might challenge. With calm reassurance, professionalism, and experience, Dr. Njo immediately guided me through the implementation of the systems and processes we needed, while also educating me extensively on compliance protocols and best practices. When the Delta auditor arrived, we were fully prepared. Together, we successfully presented and defended our office systems and processes, and we passed the audit with flying colors. Based on the experiences and stories shared by many of my colleagues, I know this situation could have easily had a very different outcome had it not been for Dr. Njo's guidance and expertise. Dr. Njo and I have now worked together for several years, and I am excited to eventually transition and sell my practice with his support and leadership. Thank you, Dr. Njo, for always being there. Your guidance has been invaluable, and your calm, kind, and thoughtful approach in everything you do has made an enormous difference in both my practice and my professional life.",
    sourceAuthorName: "Chris P",
    displayAuthorName: "Chris P",
    role: "Seminar Attendee",
    sourceDateISO: "2026-06-02",
    sortOrder: 85,
  },
  {
    id: "internal-team-member-purpose-michael-your-purpose",
    slug: "team-member-purpose-michael-your-purpose",
    source: "internal",
    category: "consulting",
    rating: 5,
    quote:
      "PURPOSE..... Michael, your purpose in making Queensboro Oral Surgery an amazing and truly functioning workplace is definitely working. There have been many positive changes since you have arrived and as for me it has helped me immensely. After your first visit I was hesitant in believing that change can occur here but it has. So a huge thank you to you!!!",
    sourceAuthorName: "Team Member",
    displayAuthorName: "Team Member",
    role: "Consulting Client",
    sortOrder: 86,
  },
  {
    id: "internal-craig-s-yarborough-dds-mba-michael-many-thanks-for",
    slug: "craig-s-yarborough-dds-mba-michael-many-thanks-for",
    source: "internal",
    category: "consulting",
    rating: 5,
    quote:
      "Michael - many thanks for your magnanimous gifts of Pride Cabernet Sauvignon and your book on Dental Practice Transitions. I sincerely appreciate the passion, wisdom, and experience you offer our students as well as our personal friendship. Best of season's greetings to you and your family.",
    sourceAuthorName: "Craig S. Yarborough, DDS, MBA",
    displayAuthorName: "Craig S. Yarborough, DDS, MBA",
    role: "Dental Educator",
    sortOrder: 87,
  },
  {
    id: "internal-armaan-grewal-favorite-part-about-dbc",
    slug: "armaan-grewal-favorite-part-about-dbc",
    source: "internal",
    category: "consulting",
    rating: 5,
    quote:
      "Favorite part about DBC is learning from Dr. Njo and working with the rest of the executive board.",
    sourceAuthorName: "Armaan Grewal",
    displayAuthorName: "Armaan Grewal",
    role: "Dugoni Business Club Member",
    sortOrder: 88,
  },
  {
    id: "internal-dr-reza-going-through-selling-your",
    slug: "dr-reza-going-through-selling-your",
    source: "internal",
    category: "seller",
    rating: 5,
    quote:
      "Going through selling your practice is similar to getting ready to treat a complex dental patient. You need to gather the pre-diagnostic history and information, conduct a thorough exam, and plan a treatment path that is in line with the patient's needs. Working with a professional like Michael, who has developed a well thought out linear path when it comes to selling dental practices, ensured that I was set up with the right candidate and the sale process was executed flawlessly. I am very happy with how things turned out.",
    sourceAuthorName: "Dr. Reza",
    displayAuthorName: "Dr. Reza",
    role: "Practice Seller",
    sortOrder: 89,
  },
  {
    id: "internal-roy-thank-you-michael-for",
    slug: "roy-thank-you-michael-for",
    source: "internal",
    category: "consulting",
    rating: 5,
    quote:
      "Thank you, Michael, for guiding me through my moment yesterday morning. As Raymund said, you truly are my dental angel. I think the realization of what just happened will sink in sometime next year! You have helped me realize my dreams come true and so much more. I appreciate all the time, patience, and care that you have given during this entire process. I appreciate your guidance as a mentor and especially as a friend.",
    sourceAuthorName: "Roy",
    displayAuthorName: "Roy",
    role: "Consulting Client",
    sortOrder: 90,
  },
  {
    id: "internal-t-w-hi-dr-njo-im",
    slug: "t-w-hi-dr-njo-im",
    source: "internal",
    category: "consulting",
    rating: 5,
    quote:
      "Hi Dr. Njo, I'm reaching out to you because of all of the dental field professionals I know, I think you are the most qualified to answer my question(s). My overarching question relates to the advice that I've heard several professionals offer about practice acquisition, which is to 'buy the biggest practice you can handle.' I have been actively informing myself on details of practice acquisition and management over the last few months. I have been listening to the Shared Practices podcast (so far I've listened to over 30 hours of practice acquisition specific information), I read your Dental Practice Transitions Handbook, I read The Million Dollar Dentist, I've read various resources from Breakaway Practices, Next Level Practices, and The Lifestyle Practice. Most of my learning helps me know what I don't know and what professionals I will need to help me in every step of my future.",
    sourceAuthorName: "T.W.",
    displayAuthorName: "T.W.",
    role: "Consulting Client",
    sortOrder: 91,
  },
  {
    id: "internal-val-dear-michael-i-just",
    slug: "val-dear-michael-i-just",
    source: "internal",
    category: "consulting",
    rating: 5,
    quote:
      "Dear Michael, I just want to express my gratitude to you for the amazing meeting. So much positive information and graceful solutions, I really appreciate it. Thank you!",
    sourceAuthorName: "Val",
    displayAuthorName: "Val",
    role: "Consulting Client",
    sortOrder: 93,
  ...
  {
    id: "internal-dana-its-my-final-day",
    slug: "dana-its-my-final-day",
    source: "internal",
    category: "consulting",
    rating: 5,
    quote:
      "It's my final day here with Dr. Carkeet, and I just wanted to take a moment to say thank you. I've learned a lot from you this past year, and I really appreciate your time and valuable knowledge.",
    sourceAuthorName: "Dana",
    displayAuthorName: "Dana",
    role: "Consulting Client",
    sortOrder: 96,
  },
  {
    id: "internal-lee-michael-what-you-did",
    slug: "lee-michael-what-you-did",
    source: "internal",
    category: "buyer",
    rating: 5,
    quote:
      "Michael, what you did was incredible, gracious, professional, and a win-win in every way. I poured my heart into the new office, and your help made an enormous difference.",
    sourceAuthorName: "Lee",
    displayAuthorName: "Lee",
    role: "Practice Owner",
    sortOrder: 97,
  ...
  {
    id: "alignable-the-phillips-group-we-confidently-recommend-dr",
    slug: "the-phillips-group-we-confidently-recommend-dr",
    source: "alignable",
    category: "consulting",
    rating: 5,
    quote:
    ...
    sourceAuthorName: "The Phillips Group",
    displayAuthorName: "The Phillips Group",
    role: "Consulting Client",
    company: "The Phillips Group",
    sortOrder: 98,
  },
  {
    id: "alignable-mary-lynn-wheaton-michael-is-one-of",
    slug: "mary-lynn-wheaton-michael-is-one-of",
    source: "alignable",
    category: "consulting",
    rating: 5,
    quote:
      "Michael is one of the most knowledgeable, well-rounded, and integrous Consultants in the business. He is very supportive of others in the industry and is diligent in his recommendations and is a tremendous communicator. He has helped navigate numerous transitions with both buyers and sellers of dental practices with his clarity and engagement.",
    sourceAuthorName: "Mary Lynn Wheaton",
    displayAuthorName: "Mary Lynn Wheaton",
    role: "Consulting Client",
    company: "MLW Customized Consulting",
    sortOrder: 99,
  },
  {
    id: "alignable-parisa-shahi-i-highly-recommend-dr",
    slug: "parisa-shahi-i-highly-recommend-dr",
    source: "alignable",
    category: "consulting",
    rating: 5,
    quote:
      "I highly recommend Dr. Njo for dental consulting services. He is bright and frank and his…",
    sourceAuthorName: "Parisa Shahi",
    displayAuthorName: "Parisa Shahi",
    role: "Consulting Client",
    company: "San Mateo Prosthodontics",
    sortOrder: 100,
  },
  {
    id: "alignable-michael-kowalski-i-recommend-dental-strategies",
    slug: "michael-kowalski-i-recommend-dental-strategies",
    source: "alignable",
    category: "consulting",
    rating: 5,
    quote:
      "I recommend Dental Strategies. Michael was very insightful and helpful in a recent transaction.",
    sourceAuthorName: "Michael Kowalski",
    displayAuthorName: "Michael Kowalski",
    role: "Consulting Client",
    company: "Michael Kowalski, D.D.S., J.D., A.P.C.",
    sortOrder: 101,
  },
  {
    id: "alignable-linda-brown-works-in-a-timely",
    slug: "linda-brown-works-in-a-timely",
    source: "alignable",
    category: "consulting",
    rating: 5,
    quote:
      "Works in a timely fashion. Clients appreciate his knowledge of dental practices.",
    sourceAuthorName: "Linda Brown",
    displayAuthorName: "Linda Brown",
    role: "Consulting Client",
    company: "LDM Commercial",
    sortOrder: 102,
  },
  {
    id: "alignable-osvaldo-ozzie-paz-highly-recommend-michaels-services",
    slug: "osvaldo-ozzie-paz-highly-recommend-michaels-services",
    source: "alignable",
    category: "consulting",
    rating: 5,
    quote:
      "Highly recommend Michael's services. His expertise and superb service are unmatched.",
    sourceAuthorName: "Osvaldo “Ozzie” Paz",
    displayAuthorName: "Osvaldo “Ozzie” Paz",
    role: "Consulting Client",
    company: "U.S. Bank",
    sortOrder: 103,
  },

  ...
  const benefits = [
    {
      ...
      description:
        "Work with a team focused on dental practice sales, acquisitions, valuations, and ownership changes.",
    },
    {
      icon: <Clock className="h-6 w-6 text-primary" />,
      title: "A Coordinated Process",
      description:
        "Keep decisions, documents, advisors, and deadlines organized while you continue caring for patients.",
    },
    {
      icon: <DollarSign className="h-6 w-6 text-primary" />,
      title: "Better Decision Support",
      description:
        "Use valuation, market context, and deal analysis to compare options on more than a headline price.",
    },
    {
      icon: <Smile className="h-6 w-6 text-primary" />,
      title: "Clear Roles and Next Steps",
      description:
        "Know who is responsible, which decision comes next, and when to involve your attorney, CPA, or lender.",
    },
  ];
  ...
  return (
    <>
        ...
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <p className="text-xl text-gray-700 animate-fade-in animate-delay-100">
              Clear guidance for selling, buying, valuing, and structuring
              ownership
            </p>
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <p className="text-gray-600 mb-4">
              Your practice is more than a business. It is the result of years
              of dedication and care. At Practice Transitions Institute, we help
              you protect that legacy, unlock value, and make confident
              decisions at every career stage.
            </p>
            <p className="text-gray-600 mb-4">
              Whether you&apos;re preparing to sell, evaluating a practice to
              buy, bringing on a partner, or simply want to understand your
              practice&apos;s worth, our expert team provides step-by-step
              support tailored to your goals.
            </p>
            <p className="text-gray-600">
              PTI provides transition strategy and transaction support, then
              coordinates with your attorney, CPA, and lender when their
              licensed expertise is required.
            </p>
          </div>
          <div className="animate-fade-in animate-delay-100">
            <div className="relative aspect-[3/2] overflow-hidden rounded-lg bg-slate-100 shadow-md">
              <Image
      ...
      <Section>
        ...
        <SectionSubtitle centered>
          Practical support for the financial, operational, and human sides of a
          transition
        </SectionSubtitle>
      ...
      <Section background="light">
        <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-6">
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We begin with a comprehensive discussion of your goals,
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Our team conducts a thorough evaluation and develops a
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We guide you through each step of the process, handling
              ...
              <div className="flex items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    We coordinate the final workstreams and help you prepare the
                    team, patients, and new owner for the handoff.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="order-1 md:order-2 animate-fade-in animate-delay-100">
            <div className="relative aspect-[1672/941] overflow-hidden rounded-lg bg-slate-100 shadow-md">
              <Image

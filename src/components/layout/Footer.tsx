    ...
    <footer className="border-t-4 border-primary bg-[#06243f] text-white print:hidden">
      <div className="container mx-auto px-4 py-12 sm:px-6 md:py-16">
        <div className="grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-[1.6fr_1fr_1fr_1.3fr] lg:gap-12">
          ...
          <div className="sm:col-span-2 lg:col-span-1">
            <Link
              ...
              className="inline-block rounded-lg focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#06243f]"
            >
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 sm:flex-row">
          <p className="order-2 text-center text-xs text-white/70 sm:order-1 sm:text-left">
